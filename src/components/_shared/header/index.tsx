...
function Header() {
  ...
  return (
    ...
    >
      ...
      <Link
        href={"/cart"}
        className="px-10 py-3 bg-white rounded-[3.125rem] justify-center items-center gap-2.5 inline-flex"
      >
        <div className="text-black text-xs sm:text-sm lg:text-base font-normal whitespace-nowrap shrink-0">
